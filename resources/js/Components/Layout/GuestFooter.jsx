                        ...
                        <div className="flex gap-4">
                            {socials.map((s, i) => (
                                <a
                                    ...
                                    className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-gray-400 hover:bg-red-600 hover:text-white transition-all no-underline"
                                >
                                    {s.icon}
                                </a>
                            ))}
                            ...
                            <ul className="flex flex-col gap-4 text-sm list-none p-0">
                                {links.map((link, i) => (
                                    <li key={i}>
                                        <Link
                                            href={link.href}
                                            className="text-gray-400 hover:text-red-600 transition-colors no-underline"
                                        >
                                            {link.label}
                                        </Link>
                                    </li>
